...
- `script.js` — navigation, GSAP hero timeline, roof layers, service tabs, reveals and form feedback
...
The inquiry form is a front-end prototype and does not send data to a backend yet.
